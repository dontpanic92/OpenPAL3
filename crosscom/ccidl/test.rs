...
,    pub render: fn (this: *const *const std::os::raw::c_void, scene_manager: &mut dyn radiance::scene::SceneManager, 
ui: &imgui::Ui, 
delta_sec: f32, 
) -> crosscom::Void
,}
...
pub fn render (&self, scene_manager: &mut dyn radiance::scene::SceneManager, 
ui: &imgui::Ui, 
delta_sec: f32, 
) -> crosscom::Void
 {
...
fn render (&self, scene_manager: &mut dyn radiance::scene::SceneManager, 
ui: &imgui::Ui, 
delta_sec: f32, 
) -> crosscom::Void
;
...
&radiance_editor::core::IViewContent::INTERFACE_ID => {
    *retval = (object as *const *const std::os::raw::c_void).offset(0);
    ...
    fn render (this: *const *const std::os::raw::c_void, scene_manager: &mut dyn radiance::scene::SceneManager, 
ui: &imgui::Ui, 
delta_sec: f32, 
) -> crosscom::Void {
        unsafe {
...
pub const GLOBAL_IViewContentVirtualTable_CCW_FOR_ResourceViewContent: radiance_editor::core::IViewContentVirtualTableCcw 
...
IViewContent: radiance_editor::core::IViewContent {
    vtable: &GLOBAL_IViewContentVirtualTable_CCW_FOR_ResourceViewContent.vtable
