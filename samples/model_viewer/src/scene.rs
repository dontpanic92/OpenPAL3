...
impl SceneCallbacks for ModelViewerScene {
    fn on_loading<T: SceneCallbacks>(&mut self, scene: &mut CoreScene<T>) {
        ...
        entity1.add_component(RenderObject::new_with_data(
            vec![
                Vertex::new(Vec3::new(-0.5, -0.5, 0.), Vec2::new(0., 1.)),
                Vertex::new(Vec3::new(0.5, -0.5, 0.), Vec2::new(1., 1.)),
                Vertex::new(Vec3::new(0.5, 0.5, 0.), Vec2::new(1., 0.)),
        ...
        entity2.add_component(RenderObject::new_with_data(
            vec![
                Vertex::new(Vec3::new(-0.5, -0.5, -1.), Vec2::new(0., 1.)),
                Vertex::new(Vec3::new(0.5, -0.5, -1.), Vec2::new(1., 1.)),
                Vertex::new(Vec3::new(0.5, 0.5, -1.), Vec2::new(1., 0.)),
