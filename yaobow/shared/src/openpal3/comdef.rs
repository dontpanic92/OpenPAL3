...
pub trait IRoleControllerImpl {
    fn get(&self) -> &'static shared::openpal3::scene::RoleController;
}
...
macro_rules! ComObject_RoleController {
    ($impl_type: ty) => {
        ...
        mod RoleController_crosscom_impl {
            ...
            use shared::openpal3::comdef::IAdventureDirectorImpl;
            use shared::openpal3::comdef::ICvdModelImpl;
            use shared::openpal3::comdef::IRoleControllerImpl;
            use shared::openpal3::comdef::IScnSceneComponentImpl;

            #[repr(C)]
            pub struct RoleControllerCcw {
                IRoleController: shared::openpal3::comdef::IRoleController,
            ...
            unsafe extern "system" fn query_interface(
                ...
                match guid.as_bytes() {
                    ...
                    &shared::openpal3::comdef::IRoleController::INTERFACE_ID => {
                        *retval = (object as *const *const std::os::raw::c_void).offset(0);
                        add_ref(object as *const *const std::os::raw::c_void);
                        crosscom::ResultCode::Ok as std::os::raw::c_long
                    }
            ...
            pub const GLOBAL_IRoleControllerVirtualTable_CCW_FOR_RoleController:
                ...
                shared::openpal3::comdef::IRoleControllerVirtualTableCcw {
                    offset: 0,
                    vtable: shared::openpal3::comdef::IRoleControllerVirtualTable {
                        query_interface,
                        add_ref,
                        release,
                        on_loading,
                    ...
                    Self::CcwType {
                        IRoleController: shared::openpal3::comdef::IRoleController {
                            vtable: &GLOBAL_IRoleControllerVirtualTable_CCW_FOR_RoleController
                                .vtable
                                as *const shared::openpal3::comdef::IRoleControllerVirtualTable,
                        },
...
pub trait IScnSceneComponentImpl {
    fn get(&self) -> &'static shared::openpal3::scene::ScnScene;
}
    ...
    ($impl_type: ty) => {
        ...
        mod ScnSceneComponent_crosscom_impl {
            ...
            pub struct ScnSceneComponentCcw {
                IScnSceneComponent: shared::openpal3::comdef::IScnSceneComponent,
            ...
            unsafe extern "system" fn query_interface(
                ...
                match guid.as_bytes() {
                    ...
                    &shared::openpal3::comdef::IScnSceneComponent::INTERFACE_ID => {
                        *retval = (object as *const *const std::os::raw::c_void).offset(0);
                        add_ref(object as *const *const std::os::raw::c_void);
                        crosscom::ResultCode::Ok as std::os::raw::c_long
                    }
            ...
            fn get(
                this: *const *const std::os::raw::c_void,
            ) -> &'static shared::openpal3::scene::ScnScene {
                unsafe {
            ...
            pub const GLOBAL_IScnSceneComponentVirtualTable_CCW_FOR_ScnSceneComponent:
                ...
                shared::openpal3::comdef::IScnSceneComponentVirtualTableCcw {
                    offset: 0,
                    vtable: shared::openpal3::comdef::IScnSceneComponentVirtualTable {
                        query_interface,
                        add_ref,
                        release,
                        on_loading,
                    ...
                    Self::CcwType {
                        IScnSceneComponent: shared::openpal3::comdef::IScnSceneComponent {
                            vtable: &GLOBAL_IScnSceneComponentVirtualTable_CCW_FOR_ScnSceneComponent
                                .vtable
                                as *const shared::openpal3::comdef::IScnSceneComponentVirtualTable,
                        },
...
impl IAdventureDirector {
    ...
    pub fn get(&self) -> &'static shared::openpal3::directors::AdventureDirector {
        unsafe {
            let this = self as *const IAdventureDirector as *const *const std::os::raw::c_void;
            let ret = ((*self.vtable).get)(this);
...
pub trait IAdventureDirectorImpl {
    fn get(&self) -> &'static shared::openpal3::directors::AdventureDirector;
}
    ...
    ($impl_type: ty) => {
        ...
        mod AdventureDirector_crosscom_impl {
            ...
            pub struct AdventureDirectorCcw {
                IAdventureDirector: shared::openpal3::comdef::IAdventureDirector,
            ...
            unsafe extern "system" fn query_interface(
                ...
                match guid.as_bytes() {
                    ...
                    &shared::openpal3::comdef::IAdventureDirector::INTERFACE_ID => {
                        *retval = (object as *const *const std::os::raw::c_void).offset(0);
                        add_ref(object as *const *const std::os::raw::c_void);
                        crosscom::ResultCode::Ok as std::os::raw::c_long
                    }
            ...
            pub const GLOBAL_IAdventureDirectorVirtualTable_CCW_FOR_AdventureDirector:
                shared::openpal3::comdef::IAdventureDirectorVirtualTableCcw =
                shared::openpal3::comdef::IAdventureDirectorVirtualTableCcw {
                    offset: 0,
                    vtable: shared::openpal3::comdef::IAdventureDirectorVirtualTable {
                        query_interface,
                        add_ref,
                        release,
                        activate,
                    ...
                    Self::CcwType {
                        IAdventureDirector: shared::openpal3::comdef::IAdventureDirector {
                            vtable: &GLOBAL_IAdventureDirectorVirtualTable_CCW_FOR_AdventureDirector
                                .vtable
                                as *const shared::openpal3::comdef::IAdventureDirectorVirtualTable,
                        },
