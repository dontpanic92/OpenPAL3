...
pub struct IPolModelVirtualTable {
...
#[repr(C)]
#[allow(dead_code)]
pub struct IPolModelVirtualTableCcw {
    pub offset: isize,
    pub vtable: IPolModelVirtualTable,
}

#[repr(C)]
#[allow(dead_code)]
pub struct IPolModel {
    pub vtable: *const IPolModelVirtualTable,
}
...
impl IPolModel {
    pub fn query_interface<T: crosscom::ComInterface>(&self) -> Option<crosscom::ComRc<T>> {
        let this = self as *const IPolModel as *const *const std::os::raw::c_void;
    ...
    pub fn uuid() -> uuid::Uuid {
        ...
        uuid::Uuid::from_bytes(IPolModel::INTERFACE_ID)
    }
}

pub trait IPolModelImpl {}

impl crosscom::ComInterface for IPolModel {
    // 7f1742f7-5330-4834-b665-6dddfd7131c8
    const INTERFACE_ID: [u8; 16] = [
        127u8, 23u8, 66u8, 247u8, 83u8, 48u8, 72u8, 52u8, 182u8, 101u8, 109u8, 221u8, 253u8, 113u8,
        49u8, 200u8,
    ];
}
        ...
        mod PolModel_crosscom_impl {
            ...
            unsafe extern "system" fn query_interface(
                ...
                match guid.as_bytes() {
                    ...
                    &opengb::classes::IPolModel::INTERFACE_ID => {
                        *retval = (object as *const *const std::os::raw::c_void).offset(0);
                        add_ref(object as *const *const std::os::raw::c_void);
                        crosscom::ResultCode::Ok as i32
                    }
            ...
            pub const GLOBAL_IPolModelVirtualTable_CCW_FOR_PolModel:
                opengb::classes::IPolModelVirtualTableCcw =
                opengb::classes::IPolModelVirtualTableCcw {
                    offset: 0,
                    vtable: opengb::classes::IPolModelVirtualTable {
                        query_interface,
                        add_ref,
                        release,
                        on_loading,
            ...
            impl crosscom::ComObject for $impl_type {
                ...
                fn create_ccw(self) -> Self::CcwType {
                    Self::CcwType {
                        IPolModel: opengb::classes::IPolModel {
                            vtable: &GLOBAL_IPolModelVirtualTable_CCW_FOR_PolModel.vtable
                                as *const opengb::classes::IPolModelVirtualTable,
                        },
