...
// Class OpenPal5ApplicationLoaderComponent

#[allow(unused)]
#[macro_export]
macro_rules! ComObject_OpenPal5ApplicationLoaderComponent {
    ($impl_type: ty) => {

#[allow(dead_code)]
#[allow(non_snake_case)]
#[allow(unused)]
mod OpenPal5ApplicationLoaderComponent_crosscom_impl {
    use crate as yaobow;
    use crosscom::ComInterface;
use crosscom::IUnknownImpl;
use crosscom::IObjectArrayImpl;
...
use radiance::comdef::IAnimationEventObserverImpl;
    ...
    #[repr(C)]
    pub struct OpenPal5ApplicationLoaderComponentCcw {
        IApplicationLoaderComponent: radiance::comdef::IApplicationLoaderComponent,
    ...
    unsafe extern "system" fn query_interface(
        ...
        let object = crosscom::get_object::<OpenPal5ApplicationLoaderComponentCcw>(this);
        match guid.as_bytes() {
...
&radiance::comdef::IApplicationLoaderComponent::INTERFACE_ID => {
    *retval = (object as *const *const std::os::raw::c_void).offset(0);
    ...
    unsafe extern "system" fn release(this: *const *const std::os::raw::c_void) -> std::os::raw::c_long {
        ...
        let previous = (*object).ref_count.fetch_sub(1, std::sync::atomic::Ordering::SeqCst);
        if previous - 1 == 0 {
            Box::from_raw(object as *mut OpenPal5ApplicationLoaderComponentCcw);
        }
    ...
    unsafe extern "system" fn on_loading (this: *const *const std::os::raw::c_void, ) -> () {
        ...
        let __crosscom_object = crosscom::get_object::<OpenPal5ApplicationLoaderComponentCcw>(this);
        (*__crosscom_object).inner.on_loading().into()
    }
...
#[allow(non_upper_case_globals)]
pub const GLOBAL_IApplicationLoaderComponentVirtualTable_CCW_FOR_OpenPal5ApplicationLoaderComponent: radiance::comdef::IApplicationLoaderComponentVirtualTableCcw
    = radiance::comdef::IApplicationLoaderComponentVirtualTableCcw {
    offset: 0,
    vtable: radiance::comdef::IApplicationLoaderComponentVirtualTable {
        query_interface,
...
on_unloading,
    ...
    impl crosscom::ComObject for $impl_type {
        type CcwType = OpenPal5ApplicationLoaderComponentCcw;

        fn create_ccw(self) -> Self::CcwType {
            Self::CcwType {

IApplicationLoaderComponent: radiance::comdef::IApplicationLoaderComponent {
    vtable: &GLOBAL_IApplicationLoaderComponentVirtualTable_CCW_FOR_OpenPal5ApplicationLoaderComponent.vtable
        as *const radiance::comdef::IApplicationLoaderComponentVirtualTable,
},
        ...
        fn get_ccw(&self) -> &Self::CcwType {
            unsafe {
                let this = self as *const _ as *const u8;
                let this = this.offset(-(crosscom::offset_of!(OpenPal5ApplicationLoaderComponentCcw, inner) as isize));
                &*(this as *const Self::CcwType)
            }
        }
    }
...
#[allow(unused)]
#[macro_export]
macro_rules! ComObject_YaobowApplicationLoader {
    ($impl_type: ty) => {

#[allow(dead_code)]
#[allow(non_snake_case)]
#[allow(unused)]
mod YaobowApplicationLoader_crosscom_impl {
    use crate as yaobow;
    use crosscom::ComInterface;
use crosscom::IUnknownImpl;
use crosscom::IObjectArrayImpl;
...
use radiance::comdef::IAnimationEventObserverImpl;
    ...
    #[repr(C)]
    pub struct YaobowApplicationLoaderCcw {
        IApplicationLoaderComponent: radiance::comdef::IApplicationLoaderComponent,
    ...
    unsafe extern "system" fn query_interface(
        ...
        let object = crosscom::get_object::<YaobowApplicationLoaderCcw>(this);
        match guid.as_bytes() {
...
&radiance::comdef::IApplicationLoaderComponent::INTERFACE_ID => {
    *retval = (object as *const *const std::os::raw::c_void).offset(0);
    ...
    unsafe extern "system" fn release(this: *const *const std::os::raw::c_void) -> std::os::raw::c_long {
        ...
        let previous = (*object).ref_count.fetch_sub(1, std::sync::atomic::Ordering::SeqCst);
        if previous - 1 == 0 {
            Box::from_raw(object as *mut YaobowApplicationLoaderCcw);
        }
    ...
    unsafe extern "system" fn on_loading (this: *const *const std::os::raw::c_void, ) -> () {
        ...
        let __crosscom_object = crosscom::get_object::<YaobowApplicationLoaderCcw>(this);
        (*__crosscom_object).inner.on_loading().into()
    }
...
#[allow(non_upper_case_globals)]
pub const GLOBAL_IApplicationLoaderComponentVirtualTable_CCW_FOR_YaobowApplicationLoader: radiance::comdef::IApplicationLoaderComponentVirtualTableCcw
    = radiance::comdef::IApplicationLoaderComponentVirtualTableCcw {
    offset: 0,
    vtable: radiance::comdef::IApplicationLoaderComponentVirtualTable {
        query_interface,
...
on_unloading,
    ...
    impl crosscom::ComObject for $impl_type {
        type CcwType = YaobowApplicationLoaderCcw;

        fn create_ccw(self) -> Self::CcwType {
            Self::CcwType {

IApplicationLoaderComponent: radiance::comdef::IApplicationLoaderComponent {
    vtable: &GLOBAL_IApplicationLoaderComponentVirtualTable_CCW_FOR_YaobowApplicationLoader.vtable
        as *const radiance::comdef::IApplicationLoaderComponentVirtualTable,
},
        ...
        fn get_ccw(&self) -> &Self::CcwType {
            unsafe {
                let this = self as *const _ as *const u8;
                let this = this.offset(-(crosscom::offset_of!(YaobowApplicationLoaderCcw, inner) as isize));
                &*(this as *const Self::CcwType)
            }
        }
    }
...
// pub use ComObject_YaobowApplicationLoader;

// Class TitleSelectionDirector

#[allow(unused)]
#[macro_export]
macro_rules! ComObject_TitleSelectionDirector {
    ($impl_type: ty) => {
        #[allow(dead_code)]
        #[allow(non_snake_case)]
        #[allow(unused)]
        mod TitleSelectionDirector_crosscom_impl {
            use crate as yaobow;
            use crosscom::ComInterface;
            use crosscom::IObjectArrayImpl;
            use crosscom::IUnknownImpl;
            ...
            #[repr(C)]
            pub struct TitleSelectionDirectorCcw {
            ...
            unsafe extern "system" fn query_interface(
                ...
                let object = crosscom::get_object::<TitleSelectionDirectorCcw>(this);
                match guid.as_bytes() {
                    &crosscom::IUnknown::INTERFACE_ID => {
                        *retval = (object as *const *const std::os::raw::c_void).offset(0);
                        add_ref(object as *const *const std::os::raw::c_void);
            ...
            unsafe extern "system" fn release(
                ...
                if previous - 1 == 0 {
                    Box::from_raw(object as *mut TitleSelectionDirectorCcw);
                }
            ...
            #[allow(non_upper_case_globals)]
            pub const GLOBAL_IDirectorVirtualTable_CCW_FOR_TitleSelectionDirector:
            ...
            impl crosscom::ComObject for $impl_type {
                type CcwType = TitleSelectionDirectorCcw;

                fn create_ccw(self) -> Self::CcwType {
                    Self::CcwType {
                        IDirector: radiance::comdef::IDirector {
                            vtable: &GLOBAL_IDirectorVirtualTable_CCW_FOR_TitleSelectionDirector
                                .vtable
                ...
                fn get_ccw(&self) -> &Self::CcwType {
                    unsafe {
                        ...
                        let this = this.offset(
                            -(crosscom::offset_of!(TitleSelectionDirectorCcw, inner) as isize),
                        );
                        &*(this as *const Self::CcwType)
                    }
                }
...
// pub use ComObject_TitleSelectionDirector;
