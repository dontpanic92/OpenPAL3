...
pub type DefaultRadianceEngine<TBackend> =
    CoreRadianceEngine<rendering::CoreRenderingEngine<TBackend>>;

pub fn create_default_radiance_engine<TBackend: backend::RenderingBackend>(
    window: &crate::rendering::Window,
) -> Result<DefaultRadianceEngine<TBackend>, Box<dyn Error>> {
