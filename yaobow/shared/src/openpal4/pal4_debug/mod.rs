...
pub use context::{create_context, Pal4DebugContext, Pal4DebugContextInner, Pal4DebugSnapshot};
...
pub const PAL4_DEBUG_P7: &str =
    include_str!(concat!(env!("OUT_DIR"), "/shared_pal4_debug.p7"));
